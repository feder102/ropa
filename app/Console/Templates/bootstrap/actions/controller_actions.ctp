 ...
 */
	public function <?php echo $admin ?>index() {
        $this->set('<?php echo $pluralName ?>', $this-><?php echo $currentModelName ?>->find('all', array('recursive' => -1, 'conditions' => array('<?php echo $currentModelName ?>.deleted' => 0),
				$this->Paginator->paginate('<?php echo $currentModelName ?>'))));
	}
