<div class="clientes form">
	...
	<div class="row">
					...
					<div class="panel-heading">Acciones</div>
						<div class="panel-body">
							<ul class="nav nav-pills nav-stacked">
							    							     <li><?php echo $this->Form->postLink(__('<span class="glyphicon glyphicon-remove"></span>&nbsp;&nbsp;Eliminar'), array('action' => 'delete', $this->Form->value('Cliente.dni')), array('escape' => false), __('Está seguro que quiere eliminar # %s?', $this->Form->value('Cliente.dni'))); ?></li>
		...
		<div class="col-md-9">
					...
					<?php echo $this->Form->input('dni', array('label' => 'dni', 'class' => 'form-control', 'placeholder' => 'Dni'));?>
				</div>
				<div class="form-group">
				...
				<div class="form-group">
					<?php echo $this->Form->input('ClienteCuenta.importe', array('disabled','label' => 'importe', 'class' => 'form-control', 'placeholder' => 'Importe de la cuenta'));?>
				</div>
				<!-- <div class="form-group">
